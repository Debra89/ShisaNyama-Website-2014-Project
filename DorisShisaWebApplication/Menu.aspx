<%@ Page Title="" MaintainScrollPositionOnPostBack="true" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="DorisShisaWebApplication.Menu" %>
...
<td >with chourizo; cherry tomatoes; potato rosti; two eggs and toast</td><td>
    <asp:Button ID="cmdorder3" runat="server" Text="Order" OnClick="cmdorder3_Click" /></td>
</tr>
...
<tr><td></td></tr>
<tr><td><a href = "Register.aspx"><h3 style="font-size: medium; font-style: italic; color: #000000; font-weight: bold;">Not Registered ?? Click here to Register</h3></a></td></tr>
</tbody></table>
</div>
</div>
</div>

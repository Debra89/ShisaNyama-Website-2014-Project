<%@ Page Title="" MaintainScrollPositionOnPostBack="true" Language="C#" MasterPageFile="~/CusMaster.Master" AutoEventWireup="true" CodeBehind="CusConfirmBooking.aspx.cs" Inherits="DorisShisaWebApplication.CusConfirmBooking" %>
              ...
              <p><label for="text">Number Of People:</label>
                  ...
                  <p> <asp:Label ID="lblMsg" runat="server" CssClass="Label" Font-Bold="True" 
					...
					<p>
					    ...
					    &nbsp;<asp:button ID="btnSubmit" Text="Confirms"  runat="server" onclick="btnSubmit_Click" CssClass="Button"/>

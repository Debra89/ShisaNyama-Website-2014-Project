<%@ Page Title="" MaintainScrollPositionOnPostBack="true" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminViewAssignedOrderTask.aspx.cs" Inherits="DorisShisaWebApplication.AdminViewAssignedOrderTask" %>
...
AllowSorting="True" DataSourceID="dsDetails" Width="540px" CssClass="Gridview" 
        ...
        CellPadding="3" CellSpacing="2" DataKeyNames="TaskID" >
...
<asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
    ...
    SelectCommand="SELECT * FROM [OrderTask] ORDER BY [Dates]" 
...
<h2>Update Order Task</h2>
        <asp:Panel ID="Panel3" runat="server" GroupingText="..." 
            HorizontalAlign="Justify">
       <p>Please select the table and Employee which you wish to update task for</p>
            <br /><br />
         <div align:="center">
            ...
            <tr>
             ...
             <tr>
                ...
                <td align:="right" class="style6">
                  Product Name:</td>
                <td style="width: 148px">
                    <asp:TextBox ID="txtproduct" runat="server" CssClass="TextinputText" 
                        Height="20px" Width="186px"></asp:TextBox>
                </td>
                <td align:="left">
